...
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1401:Fields should be private", Justification = "Want to set the BGColor variable to protected to allow access to the spreadsheetcellvalue class.", Scope = "member", Target = "~F:CptS321.SpreadsheetCell.bgColor")]
[assembly: SuppressMessage("StyleCop.CSharp.ReadabilityRules", "SA1130:Use lambda syntax", Justification = "<Want to keep it delegate {} as Venera shows in her examples>", Scope = "member", Target = "~E:CptS321.SpreadsheetCellValue.DependencyChanged")]
